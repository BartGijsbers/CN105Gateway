...
item items[] = {
    ...
    {GET_RESPONCE, 0x02, 3+5, VarType_DEFROST, "Defr", "Defrost", "Defrost"},
    ...
    {GET_RESPONCE, 0x07, 4+5, VarType_DECVALUE, "HeSt", "Heating stage?", "Heating_Stage"},
    ...
    {GET_RESPONCE, 0x13, 3+5, VarType_RUNTIME, "RunT", "HeatPump Runtime", "HeatPump_Runtime"},
    ...
    {GET_RESPONCE, 0x26, 3+5, VarType_POWER_STATE, "PwrS", "Power State", "Power_State"},
    {GET_RESPONCE, 0x26, 4+5, VarType_OPERATION_MODE, "OpMo", "Operating Mode", "Operating_Mode"},
    {GET_RESPONCE, 0x26, 5+5, VarType_HW_MODE, "HWMo", "Hot Water Mode", "Hot_Water_Mode"},
    {GET_RESPONCE, 0x26, 6+5, VarType_MODE_SETTING, "MoSe", "A/C Mode Zone 1", "AC_Mode_Zone1"}, //Operating mode room/flow/curve
    {GET_RESPONCE, 0x26, 7+5, VarType_HEAT_COOL, "HeCo", "Heating/Cooling", "Heating_Cooling"},
...
commandItem commandItems[] = {
    ...
    {3+5, SetType_None, SetCommand_SetOnOff, "ForceDHW",
        {0xfc, 0x41, 0x02, 0x7a, 0x10, 0x34, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
    {5+5, SetType_None, SetCommand_SetOnOff, "HolidayMode",
        {0xfc, 0x41, 0x02, 0x7a, 0x10, 0x34, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
    {0, 0, 0, " ",
